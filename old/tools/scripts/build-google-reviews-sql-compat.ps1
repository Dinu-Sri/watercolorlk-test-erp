...
$dst = "tmp-google-reviews-scraper-pro/google_reviews_import_compat.sql"
...
foreach ($r in $json) {
  ...
  $lines.Add("  review_id, place_id, author, rating, review_text, review_date,")
  $lines.Add("  profile_picture_local_path, profile_picture_remote_url,")
  $lines.Add("  owner_response, language, is_active, imported_at, updated_at")
  $lines.Add(") VALUES (")
  $lines.Add("  '$reviewId', '$placeId', '$author', $rating, '$reviewText', $reviewDateSql,")
  $lines.Add("  '$localPic', '$profilePictureRemote',")
